...
// Revisão cross-disciplina por Área de Conhecimento (Anatomia, Histologia...) — Etapa 6.
// Pública (sem login) por design: a lista de áreas vem de config/areasConhecimento, que tem
// leitura pública nas Security Rules. Escolher uma área e praticar de verdade exige login,
// igual o resto do app (ProtectedRoute cuida disso nas rotas /simulators/:areaId*).
        ...
        {areasConhecimento.length === 0 ? (
          ...
          <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
            {areasConhecimento.map((area) => (
              <div
                key={area.id}
                onClick={() => navigate(`/simulators/${area.id}`)}
